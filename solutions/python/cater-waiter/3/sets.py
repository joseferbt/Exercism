...
def categorize_dish(dish_name, dish_ingredients):
    ...
    """
    categories_n = ['VEGAN', 'VEGETARIAN', 'PALEO', 'KETO', 'OMNIVORE']
    categories = [VEGAN, VEGETARIAN, PALEO, KETO, OMNIVORE]

    for name, categorie in zip(categories_n,categories):
        if categorie.issuperset(dish_ingredients):
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    aux = set().union(*dishes)
    
    return aux - intersection
